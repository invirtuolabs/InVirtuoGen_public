...
| **δ = 0.4**            |        |        |         |             | **δ = 0.6** |        |        |             |
| **parp1**              |        |        |         |             |        |        |         |             |
| -7.3/0.888/2.61        | -10.6  | -9.0   | -8.3    | **-13.5 (±0.7)** | -10.4  | -      | -8.6    | **-12.4 (±0.3)** |
| -7.8/0.758/2.74        | -11.0  | -10.7  | -8.9    | **-13.2 (±0.8)** | -9.7   | -      | -8.1    | **-11.5 (±0.3)** |
| -8.2/0.438/2.91        | **-11.3** | -10.9  | -       | -10.9 (±3.0)   | -9.2   | -      | -       | **-9.5**        |
| **fa7**                |        |        |         |             |        |        |         |             |
| -6.4/0.284/2.29        | **-8.4** | -8.0   | -7.8    | **-8.4 (±0.1)** | -7.3   | **-7.6** | **-7.6** | **-7.8 (±0.2)** |
| -6.7/0.186/3.39        | **-8.4** | -      | -8.2    | **-8.4 (±0.1)** | **-7.6** | -      | **-7.6** | **-7.6 (±0.5)** |
| -8.5/0.156/2.66        | -      | -      | -       | (-8.2 ±0.4)    | -      | -      | -       | (-7.0 ±0.3)    |
| **5ht1b**              |        |        |         |             |        |        |         |             |
| -4.5/0.438/3.93        | **-12.9** | -12.1  | -11.7   | -12.8 (±0.8)   | **-12.1** | -      | -11.3   | **-12.1 (±0.8)** |
| -7.6/0.767/3.29        | **-12.3** | -9.0   | -12.1   | **-12.4 (±0.2)** | **-12.0** | -10.0  | **-12.0** | -11.9 (±0.4)   |
| -9.8/0.716/4.69        | **-11.6** | -      | -       | -11.1 (±0.3)   | **-10.5** | -      | -       | -9.8 (±0.7)    |
| **braf**               |        |        |         |             |        |        |         |             |
| -9.3/0.235/2.69        | -10.8  | **-11.6** | -9.8    | -10.2 (±0.4)   | -      | -      | -       | **-9.7**        |
| -9.4/0.346/2.49        | **-10.8** | -      | -       | **-11.0 (±1.0)** | **-9.7** | -      | -       | -9.4 (±0.1)    |
| -9.8/0.255/2.38        | -10.6  | -      | **-11.6** | -10.6 (±0.1)   | **-10.5** | -      | -10.4   | -10.2 (±0.2)   |
| **jak2**               |        |        |         |             |        |        |         |             |
| -7.7/0.725/2.89        | -10.2  | -8.2   | -8.7    | **-11.1 (±0.2)** | -9.3   | -8.1   | -       | **-10.4 (±0.3)** |
| -8.0/0.712/3.09        | -10.0  | -9.0   | -9.2    | **-10.8 (±0.3)** | -9.4   | -      | -9.2    | **-10.2 (±0.3)** |
| -8.6/0.482/3.10        | -9.8   | -      | -       | **-10.8 (±0.9)** | -      | -      | -       | **-9.5 (±0.4)** |
| **Sum**                | -148.7 | -88.5  | -96.3   | **-155.2 (-163.4)** | -117.7 | -25.7  | -74.8   | **-142.0 (-149.0)** |
```bash
